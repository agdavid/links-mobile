...
import com.nafundi.taskforce.collect.android.listeners.DiskSyncListener;
import com.nafundi.taskforce.collect.android.provider.FormsProviderAPI.FormsColumns;
import com.nafundi.taskforce.collect.android.tasks.DiskSyncTask;
...
public class FormManagerList extends ListActivity implements DiskSyncListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToggleButton = (Button) findViewById(R.id.toggle_button_form);
        ...
        Cursor c = managedQuery(FormsColumns.CONTENT_URI, null, null, null, FormsColumns.DISPLAY_NAME + " ASC");
