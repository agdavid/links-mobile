...
import com.nafundi.taskforce.collect.android.activities.GeoPointActivity;
import com.nafundi.taskforce.collect.android.activities.GeoPointMapActivity;
...
public class GeoPointWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public GeoPointWidget(Context context, FormEntryPrompt prompt) {
        ...
        final String timeoutSec = prompt.getQuestion().getAdditionalAttribute(null, TIMEOUT);
        ...
        mGetLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mUseMaps) {
                    ...
                    if (timeoutSec != null &&
                            (mStringAnswer.getText().toString() == null ||
                            mStringAnswer.getText().toString().length() == 0)) {
                        i.putExtra(TIMEOUT, Integer.valueOf(timeoutSec));
                    }
                }
