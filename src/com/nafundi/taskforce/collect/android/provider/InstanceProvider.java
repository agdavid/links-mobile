        ...
        switch (sUriMatcher.match(uri)) {
            case INSTANCES:                
                ...
                while (del.moveToNext()) {
                    ...
                    // also remove anything from the lookup database
                    String whereDel = LookupColumns.INSTANCE_PATH + "=?";
                    String[] whereArgsDel = {instanceFile};
                    Collect.getInstance().getContentResolver().delete(LookupColumns.CONTENT_URI, whereDel, whereArgsDel);
